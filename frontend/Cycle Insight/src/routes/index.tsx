...
// API contract
// ============================================================
const API_BASE_URL = "https://api.cyclelens.example.com";
const USE_MOCK = true;
...
const SAMPLE_DAYS: SampleDay[] = [
  {
    ...
    full_features: {
      resting_hr: 66,
      nightly_temperature: 36.35,
      wrist_temp_dev: -0.15,
      hrv_rmssd: 48,
      respiratory_rate: 15.6,
      sleep_minutesasleep: 402,
      sleep_score_overall: 74,
      steps_total: 5200,
      glucose_mean: 92,
      cramps: 2,
    },
  },
  {
    ...
    full_features: {
      resting_hr: 58,
      nightly_temperature: 36.52,
      wrist_temp_dev: 0.08,
      hrv_rmssd: 71,
      respiratory_rate: 14.8,
      sleep_minutesasleep: 451,
  ...
  },
  {
    ...
    full_features: {
      resting_hr: 64,
      nightly_temperature: 36.71,
      wrist_temp_dev: 0.34,
      hrv_rmssd: 52,
      respiratory_rate: 15.3,
      sleep_minutesasleep: 421,
      sleep_score_overall: 76,
      steps_total: 6800,
      glucose_mean: 96,
      cramps: 1,
    },
